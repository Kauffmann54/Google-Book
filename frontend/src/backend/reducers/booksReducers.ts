...
import { BooksModifyFavoriteResponseState, BooksListQueryResponseState, BooksResponseAction, BooksFavoriteResponseState } from "../models/book/bookResponseModel";
...
export const bookModifyFavoriteReducer = (state = {}, action: BooksResponseAction): BooksModifyFavoriteResponseState => {
    switch (action.type) {
