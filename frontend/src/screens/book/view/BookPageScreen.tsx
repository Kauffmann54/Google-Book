...
export default function BookPageScreen() {
  ...
  return (
    <PageAnimation>
        <BookMeta>
            <title>{`Livro - ${bookData ? bookData.volumeInfo.title : ''} ${process.env.REACT_APP_META_TITLE}`}</title>
            <meta name="description" content={process.env.REACT_APP_META_DESCRIPTION} />
            <meta name="keywords" content={`${process.env.REACT_APP_META_KEYWORDS}, book, book screen`} />
            <script type="application/ld+json">
                {`
                    {
                        "@context": "http://schema.org",
                        "@type": "WebSite",
                        "name": "Livro - ${bookData ? bookData.volumeInfo.title : ''} ${process.env.REACT_APP_META_TITLE}",
                        "alternateName": "Google Book",
                        "description": "${process.env.REACT_APP_META_DESCRIPTION}",
                        "url": "${process.env.REACT_APP_BOOK_SITE_URL}/book/${bookData ? bookData.id : ''}",
                    }
                    `
                }
            </script>
            ...
            <div className='book-screen-content'>
                { bookData ? (
                    <div className='book-screen-details-background'>
                        <label data-testid='book-screen-title' className='font-custom primaryTextLight book-screen-details-title'>{bookData.volumeInfo.title}</label>
